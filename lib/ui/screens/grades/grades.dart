...
class _GradesPageState extends State<GradesPage> with LayoutMixin {
    ...
    return ChangeNotifierProvider<GradesController>.value(
        ...
        child: Consumer<GradesController>(builder: (context, model, child) {
          return YPage(
              ...
              body:
                  Consumer<GradesController>(builder: (context, model, child) {
                return Column(
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: const FittedBox(
                                                    child: Image(
                                                      ...
                                                      image: AssetImage(
                                                          'assets/images/pageItems/grades/noGrades.png'),
                                                    ),
                                                  ),
                                                ),
                                                Center(
                                            ...
                                            children: <Widget>[
                                              Image(
                                                image: const AssetImage(
                                                    'assets/images/issues/totor.png'),
                                                width: screenSize.size.width /
                                                    5 *
                                                    3.5,
                                              ),
                      ...
                      SizedBox(
                        ...
                        child: Consumer<GradesController>(
                          ...
                          if (model.disciplines()!.isNotEmpty) {
                            try {
                              lastDiscipline = model.disciplines()!.lastWhere(
                                  (disciplinesList) =>
  ...
  Widget buildDefaultChoice(
      String name, IconData icon, GradesController con, String filterName) {
    var screenSize = MediaQuery.of(context);

    return Material(
      borderRadius: BorderRadius.circular(11),
      color: con.sorter == filterName
          ? Colors.green
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: <Widget>[
                  buildDefaultChoice("Pas de filtre",
                      MdiIcons.borderNoneVariant, gradesController, "all"),
                  SizedBox(height: screenSize.size.height / 10 * 0.1),
                  buildDefaultChoice("Spécialités", MdiIcons.star,
                      gradesController, "specialties"),
                  SizedBox(height: screenSize.size.height / 10 * 0.1),
                  buildDefaultChoice(
                      "Littérature",
  ...
  _buildResetButton(GradesController controller) {
    ...
    return ConstrainedBox(
      ...
      child: Container(
          ...
          child: YButton(
              onPressed: () => controller.simulationReset(),
              text: "Réinitialiser les notes",
              color: YColor.info)),
    );
  }
}
