                                        ...
                                        return Column(
                                          ...
                                          children: <Widget>[
                                                  ...
                                                  children: [
                                                    AutoSizeText(
                                                        model.sorter == "all"
                                                            ...
                                                            : "Pas de notes pour cette periode et pour le filtre sélectionné.",
                                            ...
                                            ConstrainedBox(
                                              ...
                                              child: YButton(
                                                  onPressed: forceRefreshGrades,
                                                  text: "Recharger".toUpperCase(),
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: "La moyenne auto-calculée diffère de la moyenne officielle (${model.realAverage})",
                          style:
                              TextStyle(fontFamily: "Asap", fontWeight: FontWeight.bold, color: ThemeUtils.textColor()),
                        ),
                      ],
                    ),
                  ),
