...
class _GradesGroupState extends State<GradesGroup> {
                ...
                onTap: () {
                  if (widget.discipline != null) {
                    disciplineModalBottomSheet(
                        context, widget.discipline, callback, this.widget);
                  }
                },
                child: Container(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: [
                                ...
                                if (widget.discipline!.weight != null &&
                                    widget.discipline!.weight != "1")
                                  Container(
                                      padding: EdgeInsets.all(
                                          screenSize.size.width / 5 * 0.03),
                                      margin: EdgeInsets.only(
                                          left:
                                              screenSize.size.width / 5 * 0.09),
  ...
  gradesList(int sousMatiereIndex, String? periodName) {
    ...
    List<Grade>? gradesForSelectedDiscipline =
        getGradesForDiscipline(sousMatiereIndex, periodName);
    ...
    return Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              if (gradesForSelectedDiscipline != null) {
                try {
                  if (marksColumnController.hasClients) {
                ...
                if (DateFormat('yyyy-MM-dd').format(
                        gradesForSelectedDiscipline[index].entryDate!) ==
              ...
              return Badge(
                ...
                child: Container(
                  ...
                  margin: EdgeInsets.only(
                      left: screenSize.size.width / 5 * 0.025,
                      right: screenSize.size.width / 5 * 0.025),
                  child: DottedBorder(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          GradesStats stats = GradesStats(
                              gradesForSelectedDiscipline![index],
                              getAllGrades(
                                  widget.gradesController!.disciplines(),
                                  overrideLimit: true,
                              ...
                              if (gradesForSelectedDiscipline != null)
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: gradesForSelectedDiscipline[index]
                                            .simulated!
                                        ? null
                                        : Border.all(
