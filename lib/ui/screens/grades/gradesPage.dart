          ...
          child: FloatingActionButton(
            ...
            onPressed: () async {
              Grade a = await simulatorModalBottomSheet(
                  this.widget.gradesController, context);
              if (a != null) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Material(
                      color:
                          ThemeUtils.isThemeDark ? Colors.white10 : Colors.grey,
                      borderRadius: BorderRadius.all(Radius.circular(30)),
                      child: InkWell(
                        borderRadius: BorderRadius.all(Radius.circular(30)),
                        onTap: () {
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 0.00000, color: Colors.transparent),
                          ),
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(
                                    left: (screenSize.size.height / 10 * 8.8) /
                                        10 *
                                        0.1),
                                child: Material(
                                  color: Theme.of(context).primaryColor,
                              ...
                              if (model.disciplines != null) {
                                try {
                                  lastDiscipline = model
                                      .disciplines()
                                      .lastWhere((disciplinesList) =>
                                          disciplinesList.period ==
                                          model.period);
                                } catch (exception) {}
                                                                ...
                                                                padding: EdgeInsets.symmetric(
                                                                    horizontal:
                                                                        (screenSize.size.width /
                                                                                5) *
                                                                            0.1,
                                                                    vertical: (screenSize.size.width /
                                                                            5) *
                                                                        0.08),
                                                                child: Text(
                                                                  (lastDiscipline !=
