...
import 'package:ynotes/ui/screens/summary/widgets/chart.dart';
...
class QuickGrades extends StatefulWidget {
  const QuickGrades({Key? key}) : super(key: key);
  @override
            ...
            child: Container(
              ...
              child: Container(
                  ...
                  child: ((disciplines != null) || !fetching)
                      ...
                      : CustomLoader(
                          screenSize.size.width / 5 * 2.5, screenSize.size.width / 5 * 2.5, const Color(0xff5c66c1))),
            )));
  }
