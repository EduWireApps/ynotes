...
class GradesChart extends StatelessWidget {
  ...
  List<ChartElement> get els => elements.reversed
      .toList()
      .sublist(0, min(elements.length, r<int>(def: 4, sm: 6, lg: 8)))
      .reversed
      .toList();
    ...
    return LineChart(LineChartData(
      ...
      lineTouchData: LineTouchData(
          touchTooltipData: LineTouchTooltipData(
              ...
              getTooltipItems: (spots) => spots
                  .map((spot) => LineTooltipItem(spot.y.toString(),
                      TextStyle(color: theme.colors.foregroundColor)))
                  .toList())),
      ...
      titlesData: FlTitlesData(
        ...
        bottomTitles: SideTitles(
            ...
            getTextStyles: (context, _) => theme.texts.body2.copyWith(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: List.generate(els.length,
              (index) => FlSpot(index.toDouble(), els[index].value)),
          isCurved: true,
