    ...
    if (listFiles != null) {
      switch (actualSort) {
        case explorerSortValue.name:
          setState(() {
            (listFiles ?? []).sort((a, b) => (a.fileName!.toLowerCase())
