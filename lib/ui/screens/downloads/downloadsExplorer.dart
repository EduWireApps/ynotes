                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(
                                      screenSize.size.width / 5 * 0.15),
                                  onTap: () async {
                                    String newName = await CustomDialogs
                                        .showTextChoiceDialog(context,
                                            text: "un nom pour l'élément",
                                            defaultText: await FileAppUtil
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            if (selectionMode) {
                              ...
                              setState(() {
                                int index = explorerSortValue.values
                                    .indexOf(actualSort);
                                actualSort = explorerSortValue.values[index +
                                    (index ==
                                    ...
                                    AnimatedSwitcher(
                                      ...
                                      child: selectionMode
                                          ? Icon(
                                              Icons.delete,
                                              key:
                                                  ValueKey<bool>(selectionMode),
                                              color: Colors.red,
                                            )
                                          : Icon(
                                              case2(actualSort, {
                                                explorerSortValue.date:
                                                    MdiIcons.sortAscending,
                                                explorerSortValue.reversed_date:
                                                    MdiIcons.sortDescending,
                                                explorerSortValue.name: MdiIcons
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    setState(() {
                                      clipboard.clear();
                                      clipboard.addAll(_listFiles.where(
                                          (element) => element.selected));
                                    });
                                  },
                                  child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: !(clipboard.length > 0)
                                ? null
                                : () async {
                                    await Future.forEach(clipboard,
                                        (FileInfo element) async {
                                      try {
                                        await element.element.copy(initialPath +
                                            path +
                                            "/" +
                                            element.fileName);
                                      } catch (e) {
                          ...
                          children: <Widget>[
                            ConstrainedBox(
                              constraints: BoxConstraints(
                                  maxHeight: screenSize.size.height / 10 * 1.2),
                              child: FittedBox(
                                child: Icon(
