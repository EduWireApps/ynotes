...
class _DayNightSwitchState extends State<DayNightSwitch> with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    ...
    return _SwitchRenderObjectWidget(
      ...
      additionalConstraints: BoxConstraints.tight(Size(_kSwitchWidth, _kSwitchHeight)),
      vsync: this,
    );
  }
}
...
class _RenderSwitch extends RenderToggleable {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    canvas.drawLine(
      ...
      Offset(offset.dx + (_kSwitchWidth * 0.1) + (_kSwitchWidth / 2 * (1 - currentValue)), offset.dy),
      linePaint,
    );

    canvas.drawLine(
      Offset(offset.dx + _kSwitchWidth * 0.2, offset.dy + _kSwitchHeight),
      Offset(offset.dx + (_kSwitchWidth * 0.2) + (_kSwitchWidth / 2 * (1 - currentValue)), offset.dy + _kSwitchHeight),
      linePaint,
    );
