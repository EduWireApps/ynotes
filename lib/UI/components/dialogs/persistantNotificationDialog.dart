              ...
              child: Column(
                children: [
                  Container(
                      ...
                      child: Image(width: screenSize.size.width / 5 * 4, height: screenSize.size.height / 10 * 1.8, fit: BoxFit.scaleDown, image: AssetImage('assets/images/persistantNotification/persisIllu${isDarkModeEnabled ? "Dark" : "Light"}.png'))),
                  Container(
                    ...
                    child: AutoSizeText.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(text: ' notification toujours présente', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              onChanged: (value) async {
                ...
                if (value && (await getCurrentLesson(await localApi.getNextLessons(DateTime.now()))) != null) {
                  if (await FlutterDnd.isNotificationPolicyAccessGranted) {
                    ...
                    if (await CustomDialogs.showAuthorizationsDialog(context, "mode ne pas déranger", "Allumer ou éteindre le mode ne pas déranger dans la journée.")) {
