                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: GestureDetector(
                        ...
                        onLongPress: () {
                          showHomeworkDetails(context, segmentedControlIndex == 0 ? this.widget.homeworkForThisDay.contenu : this.widget.homeworkForThisDay.contenuDeSeance, this.widget.homeworkForThisDay);
                        },
                        child: Container(
                          decoration: BoxDecoration(
