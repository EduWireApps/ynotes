    ...
    try {
      if (selector == null) {
        if (parent.agendaEventsData != null &&
            parent.agendaEventsData![week] != null) {
          List<AgendaEvent> agendaEvents = [];
          agendaEvents
              .addAll(parent.agendaEventsData![week].cast<AgendaEvent>());
          return agendaEvents;
        } else {
        ...
        if (parent.agendaEventsData != null) {
          ...
          selectedValues.forEach((element) {
            agendaEvents
                .addAll(parent.agendaEventsData![element].cast<AgendaEvent>());
            print(agendaEvents);
          });
          return agendaEvents;
        } else {
          ...
          if (parent.agendaEventsData != null) {
            ...
            selectedValues.forEach((element) {
              agendaEvents.addAll(
                  parent.agendaEventsData![element].cast<AgendaEvent>());
            });
            return agendaEvents;
          } else {
            return null;
      ...
      print(
          "Error while returning agenda events for week $week " + e.toString());
      return null;
    }
  }
      ...
      try {
        ...
        if (offline != null) {
          timeTable = Map<dynamic, dynamic>.from(
              await parent.agendaBox?.get("agendaEvents"));
        }
